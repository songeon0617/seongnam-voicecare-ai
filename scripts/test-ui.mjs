...
for(const suite of ["question-panel.spec.ts","voice-panel.spec.ts","expanded-panel.spec.ts","submission-panel.spec.ts","competition-flow.spec.ts","voice-first.spec.ts"]){
